<div class="lg:flex lg:items-center lg:justify-between py-6 border-b-2">
    <div class="min-w-0 flex-1">
        <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-2xl sm:tracking-tight">{{$jobTitle}}</h2>
    ...
    <div class="mt-5 flex lg:ml-4 lg:mt-0">
        ...
        @if ($publish=='1')
        <form action="/publish/{{$id}}" method="post">
            @csrf
            <span class="sm:ml-3">
                <button type="submit"
