                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="col-span-full">
                            <label for="organization-name" class="block text-sm font-medium leading-6 text-gray-900">Organization
                                name</label>
                            <div class="mt-2">
                                <input value="{{old('name')}}" type="text" name="name" id="organization-name" autocomplete="given-name"
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea id="about" name="address" rows="3"
                                    class="block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{old('address')}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
