<x-layout>
    <x-slot:pageTitle>Job Update</x-slot:pageTitle>
    <ul class="py-4">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <input value="{{$job->title}}" type="text" name="title" id="first-name" autocomplete="given-name"
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="about" name="body" rows="3"
                                class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{$job->body}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <input value="{{$job->address}}" id="email" name="address" type="text" autocomplete="email"
                                class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <input value="{{$job->salary}}" id="email" name="salary" type="text" autocomplete="" placeholder="120K - 150K"
                                class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    ...
                    <div class="col-span-3">
                        ...
                        <div class="mt-2">
                            <input value="{{$job->deadline}}" type="date" name="deadline" id="street-address" autocomplete="street-address"
                                class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                </div>
